...
<body>
    ...
    <?php   
        ...
        */
        ...
        echo "Panjang string: $length_first, <br>" ;
        echo "Jumlah kata : $word_count_first <br>";
        ...
        echo "Panjang string: $length_second, <br>" ;
        echo "Jumlah kata: $word_count_second <br>";
